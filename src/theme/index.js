export default {
  ...
  colors: {
    ...
    secondary: '#EA3A60', // secondary color - can be used for hover states
  ...
  buttons: {
    ...
    // marginTop: 5,
    // marginRight: 20,
    // boxShadow: '0 7px 25px rgb(123 104 238 / 25%)',
      borderRadius: '45px',
    ...
    primary: {
      ...
      // },
      '&:hover': {
        boxShadow: 'rgba(0, 0, 0, 0.5) 0px 9px 20px -5px',
      },
    },
    whiteButton: {
      variant: 'buttons.defaultBtn',
